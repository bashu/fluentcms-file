...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FileItem'
        db.create_table('contentitem_fluentcms_file_fileitem', (
        ...
        db.send_create_signal('fluentcms_file', ['FileItem'])


    def backwards(self, orm):
        # Deleting model 'FileItem'
        db.delete_table('contentitem_fluentcms_file_fileitem')
